          ...
          >
            <div
              ...
              style={{
                ...
                height: "7rem",
                cursor: "pointer",
                border: `solid 2px ${select  ?  "#0B093B":"black"}`,
              ...
              onClick={() => {
                Setselect();
                localStorage.setItem("pocket", "none");
              }}
            >
              <img src={nopocket} alt="iconconcal" style={{}} />
            ...
            <div
              ...
              style={{
                ...
                height: "7rem",
                cursor: "pointer",
                border: `solid 2px ${select === pocket1 ? "#0B093B" : "#dddddd"}`,
              ...
              onClick={() => {
                Setselect(pocket1);
                localStorage.setItem("pocket", "pocket1");
              }}
            >
              <img src={singlepocket} alt="iconspread" style={{}} />
              <p style={{ textAlign: "center" }}>singlepocket</p>
            </div>
            <div
              className="card"
              style={{
                ...
                height: "7rem",
                cursor: "pointer",
                border: `solid 2px ${select === pocket2 ? "#0B093B" : "#dddddd"}`,
              ...
              onClick={() => {
                Setselect(pocket2);
                localStorage.setItem("pocket", "pocket2");
              }}
            >
              <img src={angledpocket}  alt="iconsprince" style={{}} />
              <p style={{ textAlign: "center" }}>angledpocket</p>
            </div>
            {/* <div
              className="card"
              style={{
